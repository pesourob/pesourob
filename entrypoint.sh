...
/opt/ibm/wlp/bin/collective create controller --keystorePassword=password123 --createConfigFile=/opt/ibm/wlp/usr/servers/controller/ --hostName=websphere-liberty-controller-0.websphere-liberty-controller.pesourob-was-liberty.svc.cluster.local
